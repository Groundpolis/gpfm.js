...
export declare const SUP: (children: MfmInline[]) => NodeType<'sup'>;
export declare type MfmSub = {
    type: 'sub';
    props?: Record<string, unknown>;
    children: MfmInline[];
};
export declare const SUB: (children: MfmInline[]) => NodeType<'sub'>;
export declare type MfmInline = MfmUnicodeEmoji | MfmEmojiCode | MfmBold | MfmSmall | MfmItalic | MfmStrike | MfmInlineCode | MfmMathInline | MfmMention | MfmHashtag | MfmUrl | MfmLink | MfmFn | MfmText | MfmSup | MfmSub;
